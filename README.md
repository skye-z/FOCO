...
- [LEARNING_INTELLIGENCE_DESIGN.md](./docs/LEARNING_INTELLIGENCE_DESIGN.md)
- [DESIGN_DECISIONS.md](./docs/DESIGN_DECISIONS.md)
- [SCORECARD.md](./docs/SCORECARD.md)
- [DEMO_SCRIPT.md](./docs/DEMO_SCRIPT.md)
- [FOCO.postman_collection.json](./docs/FOCO.postman_collection.json)
...
- 已提供知识图谱可视化与策略解释字段
- 已补齐性能优化 / 安全设计 / CI-CD / 监控设计证据，详见 [docs/SCORECARD.md](./docs/SCORECARD.md)
